#!/bin/bash
set -euo pipefail
python clip_benchmark.py --device_id="cuda" --runtime="onnx_tensorrt" --batch_size=128
...
# python clip_benchmark.py --device_id="cuda" --runtime="onnx_tensorrt" --batch_size=4
...
# python clip_benchmark.py --device_id="cuda" --runtime="torch_jit" --batch_size=4
